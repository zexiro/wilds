 ...
 *
 * Video IDs may need periodic updating as YouTube live streams restart.
 * Channel IDs are stable and can be used to find current streams.
 *
 * To find updated video IDs, visit the channel's YouTube page and check
 * the /streams tab, or use the YouTube Data API with:
 *   search?channelId=CHANNEL_ID&eventType=live&type=video
 */
